class BoostPython3 < Formula
  ...
  test do
    ...
    pyincludes = Utils.popen_read("#{Formula["python@3.8"].opt_bin}/python-config --includes").chomp.split(" ")
    pylib = Utils.popen_read("#{Formula["python@3.8"].opt_bin}/python-config --ldflags --embed").chomp.split(" ")
