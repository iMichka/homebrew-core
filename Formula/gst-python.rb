class GstPython < Formula
  ...
  def install
    ...
    python_flags = `#{Formula["python@3.8"].opt_bin}/python-config --ldflags --embed`.chomp
  ...
  test do
    system "#{Formula["gstreamer"].opt_bin}/gst-inspect-1.0", Formula["python@3.8"].opt_bin/"python3"
